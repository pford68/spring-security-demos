...
keytool -genkeypair -alias serverkey -keyalg RSA -keysize 2048 -dname "CN=localhost,OU=Web Development,O=Home,L=Bethesda,S=MD,C=US" -keypass password -storepass password -keystore server.jks
keytool -genkeypair -alias clientkey -keyalg RSA -keysize 2048 -dname "CN=Ford Philip Anthony pford,OU=Web Development,O=Home,L=Bethesda,S=MD,C=US" -keypass password -storepass password -keystore client.jks
